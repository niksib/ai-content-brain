...
### Structure
- Mix sentence lengths — short, medium, long, fragment, short
- Never write more than 3 sentences of similar length in a row
- Break long paragraphs — social media readers scan, not read
- Use white space as punctuation
- Fragments are fine. People use them. Constantly.

### Language
- Use the simplest word that carries the meaning — "use" not "utilize", "help" not "facilitate"
- Be specific — numbers, names, exact situations beat vague descriptions
- Write for how people speak, not how they write essays
- Contractions always (it's, I've, they're, won't, didn't)
- "But", "And", "So" can start sentences
...
- "As we can see..."
- "Key takeaways:"
- Any ending that summarizes what was just said
...
- Three parallel items with identical structure ("First X, then Y, and finally Z")
- Every paragraph starting the same way
- Intro that explains what the post will cover
- Summary conclusion
...
- Is there any word that feels "written" rather than "spoken"?
- Does it have rhythm and variation?
- Is every statement specific or does some of it float in abstraction?
